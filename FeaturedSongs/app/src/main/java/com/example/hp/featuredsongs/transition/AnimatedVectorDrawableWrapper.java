...
package com.example.hp.featuredsongs.transition;
...
public class AnimatedVectorDrawableWrapper extends Animator {
    ...
    public void addListener(AnimatorListener listener) {
        ...
        if (!mListeners.containsKey(listener)) {
            ...
            com.example.hp.featuredsongs.transition.AnimatedVectorDrawableCompat.addListener(mAnimatedVectorDrawable, wrapper);
        }
    }
    ...
    public void removeListener(AnimatorListener listener) {
        ...
        if (wrapper != null) {
            ...
            com.example.hp.featuredsongs.transition.AnimatedVectorDrawableCompat.removeListener(mAnimatedVectorDrawable, wrapper);
        }
    }
