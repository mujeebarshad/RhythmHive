...
public class QueueAdapter extends RecyclerView.Adapter<QueueAdapter.MyViewHolder> {
    ...
    public QueueAdapter(Context mContext, List<QueuedSong> albumList) {
    ...
    public void onBindViewHolder(final MyViewHolder holder, int position) {
       QueuedSong complete_song = albumList.get(position);
    ...
    private void showPopupMenu(View view) {
        ...
        inflater.inflate(R.menu.queue_menu, popup.getMenu());
        ...
        public boolean onMenuItemClick(MenuItem menuItem) {
            switch (menuItem.getItemId()) {
                case R.id.action_add_queue:
                    Toast.makeText(mContext, "Remove from Queue", Toast.LENGTH_SHORT).show();
                    return true;
